 ...
 //   });
  ...
  $.i18n().load({
    'en': {
      ...
      'ui_gallery': 'Gallery',
      'ui_archive': 'Archive',
      'ui_briefing': 'Briefing',
      'ui_transport': 'Tape transport',
      'ui_rew': 'Rewind',
      'ui_play': 'Play',
      'ui_ff': 'Fast forward',
      'ui_stop': 'Stop',
      'ui_press_play': 'Press play to open',
      'ui_work': 'Work',
      'ui_app': 'App',
      'hoy_sub': 'Hoy is a personal diary for writing without distractions and without handing your data to anyone. Built for personal use, and published as a project afterwards.',
      'hoy_h_what': 'How it works',
      'hoy_p1': 'Everything you write stays on your own device. No sign-up, no subscription, no internet connection. There is no server to send anything to, no account to create and no advertising, and there is no paid tier holding features back.',
      'hoy_p2': 'Each entry takes free text, an optional title and a photo, and you move between days with a gesture. Entries are organised with your own colour-coded tags, and with epochs — the long stretches of a life: a new job, a long trip, a period of change.',
      'hoy_p3': 'You can also define your own metrics, whatever you care to track: weight, hours of sleep, mood, kilometres walked. The app records them alongside each entry and charts how they move over the months.',
      'hoy_p4': 'Backups export as a ZIP whenever you want, and the diary can also come out as a PDF.',
      'hoy_cta': 'Get it on Google Play',
      'oasis_sub': 'I have been part of Immersive Oasis since 2021, an extended reality studio based in Asturias.',
      'oasis_h_studio': 'The studio',
      'oasis_p1': '<a href="https://immersiveoasis.io" target="_blank" rel="noopener">Immersive Oasis</a> designs and develops interactive and immersive experiences for Extended Reality (XR) and spatial computing. It was founded in Asturias in 2020 and works with both companies and public institutions.',
      'oasis_p2': 'Its main lines are virtual reality applications, location-based entertainment, mixed reality content and 360-degree video, along with the hardware support that goes with them.',
      ...
      'index_p4' : 'Currently living in Oviedo, creating virtual reality experiences at <a href="immersiveOasis.html">Immersive Oasis</a>.',
      ...
      'difPlanet_p4': 'It plays as a platformer in which you must visit all the planets to open the gate to the next sector, while accounting for the gravity of the different celestial bodies.',
      ...
      'studies_p1':'Between 2017 and 2022 I took a degree in video game development at ESNE.',
    ...
    'es': {
      ...
      'ui_profile': 'Perfil',
      'ui_contact': 'Contacto',
      'ui_screenshots': 'Capturas',
      'ui_gameplay': 'Gameplay',
      'ui_gallery': 'Galería',
      'ui_archive': 'Archivo',
      'ui_briefing': 'Resumen',
      'ui_transport': 'Transporte de cinta',
      'ui_rew': 'Rebobinar',
      'ui_play': 'Reproducir',
      'ui_ff': 'Avance rápido',
      'ui_stop': 'Parar',
      'ui_press_play': 'Pulsa play para abrir',
      'ui_work': 'Trabajo',
      'ui_app': 'App',
      'hoy_sub': 'Hoy es un diario personal para escribir sin distracciones y sin ceder tus datos a nadie. Creada para uso personal y publicada como proyecto a posteriori.',
      'hoy_h_what': 'Cómo funciona',
      'hoy_p1': 'Todo lo que escribes se queda en tu propio dispositivo. Sin registro, sin suscripción y sin conexión a internet. No hay ningún servidor al que enviar nada, no hay cuenta que crear ni publicidad, y no hay versión de pago que esconda funciones.',
      'hoy_p2': 'Cada entrada admite texto libre, un título opcional y una foto, y se navega entre días con un gesto. Las entradas se organizan con etiquetas de colores propios y con épocas: los periodos largos de una vida, un trabajo nuevo, un viaje, una etapa de cambio.',
      'hoy_p3': 'También puedes definir tus propias métricas, lo que te interese medir: peso, horas de sueño, ánimo, kilómetros andados. La app las registra junto a cada entrada y dibuja su evolución a lo largo de los meses.',
      'hoy_p4': 'Las copias de seguridad se exportan en ZIP cuando quieras, y el diario entero puede salir también como PDF.',
      'hoy_cta': 'Descargar en Google Play',
      'oasis_sub': 'Desde 2021 formo parte de Immersive Oasis, una empresa de realidad extendida con sede en Asturias.',
      'oasis_h_studio': 'La empresa',
      'oasis_p1': '<a href="https://immersiveoasis.io" target="_blank" rel="noopener">Immersive Oasis</a> diseña y desarrolla experiencias interactivas e inmersivas para realidad extendida (XR) y computación espacial. Nació en Asturias en 2020 y trabaja tanto con empresas como con instituciones públicas.',
      'oasis_p2': 'Sus líneas principales son las aplicaciones de realidad virtual, el entretenimiento ubicado en espacios físicos, el contenido de realidad mixta y el vídeo 360º, junto con el soporte de dispositivos que todo eso necesita.',
      ...
      'index_p4' : 'Actualmente resido en Oviedo, creando experiencias de realidad virtual en <a href="immersiveOasis.html">Immersive Oasis</a>.',
      ...
      'becomeRed_p2':'Vertí sudor y lágrimas en este proyecto durante 300 horas, así que todo el diseño, código y todos los demás elementos han sido hechos por mí desde cero, excepto por la música, animaciones y algunos de los efectos sonoros.',
      ...
      'everydays_p1':'Desde enero del 2020 hasta octubre del 2022, un render al día durante 1000 días.',
      ...
      'studies_p2' :'Durante mi primer año, empleé el sistema de formularios de Windows para crear una implementación del puzle conocido como nonograma, creado por el diseñador Tetsuya Nishio.',
      'studies_p3' :'Incluye más de 30 nonogramas de diferentes tamaños. Dentro de cada puzle el jugador ha de adivinar cuáles de las casillas son parte del dibujo empleando la información dada. Los dibujos son leídos desde archivos .txt en tiempo de ejecución. Tras cometer un número máximo de errores, que vienen dados por el tamaño del puzle, el jugador habrá perdido y deberá reiniciar.',
